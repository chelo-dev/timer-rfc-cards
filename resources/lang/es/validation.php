...
return [
    ...
    */
    ...
    'custom' => [
        'amenazas_id' => [
            'unique' => 'El valor del campo amenazas ya está en utilización.',
        ],
        'activos_id' => [
            'unique' => 'El valor del campo activo ya está en utilización.',
        ],
        'frameworks_id' => [
            'unique' => 'El valor del campo frameworks ya está en utilización.',
        ],
        'nivel_riesgo' => [
            'unique' => 'El valor del campo clasificación ya está en utilización.',
        ],
        'descripcion' => [
            'unique' => 'El campo descripción es obligatorio.',
        ],
    ],
